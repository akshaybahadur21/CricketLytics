...
class LeftHandedBatting(Batting):
    def __init__(self):
        ...
        self.threaded_camera_front = ThreadedCamera("resources/left_front.mp4")
        self.cap_front = cv2.VideoCapture("resources/left_front.mp4")
        self.threaded_camera_side = ThreadedCamera("resources/left_side.mp4")
        self.cap_side = cv2.VideoCapture("resources/left_side.mp4")
